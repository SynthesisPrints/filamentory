...
export default function Page() {
	return (
		<>
			...
			<div data-theme="light" className="grid grid-cols-3 place-items-center">
				<div className="aspect-square size-full bg-base-100">bg-base-100</div>
				<div className="aspect-square size-full bg-base-200">bg-base-200</div>
				<div className="aspect-square size-full bg-base-300">bg-base-300</div>
			</div>

			<div data-theme="dark" className="grid grid-cols-3 place-items-center">
				<div className="aspect-square size-full bg-base-100">bg-base-100</div>
				<div className="aspect-square size-full bg-base-200">bg-base-200</div>
				<div className="aspect-square size-full bg-base-300">bg-base-300</div>
			</div>
					...
					<div className="flex flex-col gap-3">
						...
						<div className="flex flex-col gap-3 md:flex-row">
							...
							<div className="flex flex-wrap items-center justify-center gap-3 md:w-1/2">
								<div className="radial-progress" style={{ '--value': 60, '--size': '3.5rem' }}>
									60%
								</div>
								<div className="radial-progress" style={{ '--value': 75, '--size': '3.5rem' }}>
									75%
								</div>
								<div className="radial-progress" style={{ '--value': 90, '--size': '3.5rem' }}>
									90%
								</div>
							</div>
						</div>

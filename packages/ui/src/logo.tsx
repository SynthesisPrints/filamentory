...
export const Logo = (props: SVGProps<SVGSVGElement>) => (
	<svg xmlns="http://www.w3.org/2000/svg" width="100" height="88" viewBox="0 0 100 88" {...props}>
		<style>{'path{fill:#18181b}@media (prefers-color-scheme:dark){path{fill:#a6adbb}}'}</style>
		<path
			fillRule="evenodd"
